...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2018 at 09:45 AM
...
--
ALTER TABLE `msrequest`
  MODIFY `Scheduleld` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `msschedule`
--
ALTER TABLE `msschedule`
  MODIFY `ScheduleId` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
